...
import com.microservice3.notificationservice.event.OrderPlacedEventSerDes;
...
public class KafkaListenerConfig {
    ...
    public ConsumerFactory<String, OrderPlacedEvent> consumerFactory(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, OrderPlacedEventSerDes.class);
